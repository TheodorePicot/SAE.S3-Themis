<div class="container-fluid">
    <div class="row my-5 mx-5">
        ...
        <div class="container my-4 col-md-10 col-lg-4 card-body border-0 rounded-4" style="background: #C7B198;">
                ...
                <fieldset>
                    ...
                    <div class="my-4">
                        ...
                        <div class="mx-3">
                            ...
                            <p>
                                <input class="form-control" type="text" placeholder="Paul16" name="login" id="login"
                                       required/>
                            </p>
                        </div>
                        ...
                        <div class="mx-3 ">
                            ...
                            <p>
                                <input class="form-control" type="password" name="mdp" id="mdp" minlength="8" required/>
                            </p>
                        </div>
